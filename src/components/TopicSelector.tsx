...
export const TopicSelector: React.FC<TopicSelectorProps> = ({ 
  ...
  return (
    <div className="w-full space-y-10 select-none bg-[#050505] p-8 md:p-14 rounded-[3.5rem] md:rounded-[5rem] border border-white/5 shadow-[0_60px_150px_rgba(0,0,0,0.95)] relative overflow-hidden max-w-5xl mx-auto group/container italic">
