...
export const ThemeSelector: React.FC<ThemeSelectorProps> = ({ onComplete }) => {
  ...
  // ✅ CORRECCIÓN: Aseguramos que los valores por defecto coincidan con el esquema global
  ...
  return (
    <motion.div 
      ...
      className="bg-black border-2 border-white/10 backdrop-blur-3xl rounded-[3.5rem] p-8 md:p-12 w-full max-w-[750px] shadow-[0_60px_120px_rgba(0,0,0,1)] relative overflow-hidden mx-auto selection:bg-white/20"
    >
      ...
      <div className="flex items-center justify-between mb-8 px-2">
        <div className="flex items-center gap-6">
          ...
          <div className="flex flex-col">
            <h3 className="text-[10px] font-black uppercase tracking-[0.5em] text-white italic leading-none">Configuración_Nodo</h3>
      ...
      {/* GRID DE COLORES (High-Performance Interaction) */}
      ...
      <div className="mb-10">
        <div className="flex items-center gap-3 mb-5 opacity-40">
          ...
          <h4 className="text-[10px] font-[1000] uppercase tracking-[0.6em] text-white italic leading-none">Protocolo_De_Acceso</h4>
        </div>
      ...
      <div className="mb-12 space-y-6">
        <div className="flex items-center gap-3 opacity-40">
          ...
          <h4 className="text-[10px] font-[1000] uppercase tracking-[0.6em] text-white italic leading-none">Trends_Sincronizados</h4>
        </div>
        ...
        <input 
          ...
          className="w-full bg-[#050505] border-2 border-white/5 p-6 rounded-3xl text-[12px] font-black uppercase tracking-[0.3em] italic focus:border-white/30 focus:bg-black outline-none transition-all text-white placeholder:text-zinc-900 shadow-inner"
        />
      </div>
      ...
      >
        <span className="text-black font-[1000] uppercase text-sm tracking-[0.6em] italic">Iniciar_Protocolo</span>
